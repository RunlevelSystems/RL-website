            ...
            <div class="col-sm-12">
                <div style="display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 20px;">
                    ...
                    <div style="flex: 1; min-width: 200px;">
                        <?php if ($prev_project): ?>
                            <a href="/projects/<?php echo $prev_project; ?>" style="text-decoration: none; color: #8B7355; display: block; padding: 15px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; transition: all 0.3s ease;">
                    ...
                    <div style="text-align: center;">
                        <a href="/projects.php" style="text-decoration: none; color: #8B4513; display: inline-flex; align-items: center; gap: 8px; padding: 12px 24px; background: rgba(0, 200, 81, 0.1); border: 1px solid #8B4513; border-radius: 6px; font-weight: bold; transition: all 0.3s ease;">
                    ...
                    <div style="flex: 1; min-width: 200px; text-align: right;">
                        <?php if ($next_project): ?>
                            <a href="/projects/<?php echo $next_project; ?>" style="text-decoration: none; color: #8B7355; display: block; padding: 15px; background: #1a1a1a; border: 1px solid #333; border-radius: 8px; transition: all 0.3s ease;">
