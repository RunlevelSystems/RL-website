...
<html lang="en">
    ...
    <body>
        <?php
        $current_page = 'game-server-support';
        $header_class = 'inner-header';
        $page_subtitle = 'Custom Scripts, Mod Installation, Server Fixes & Community Tools';
        ?>
        <?php include 'includes/header.php'; ?>
        <?php include 'includes/navigation.php'; ?>

        <main class="service-site" aria-label="Mods and custom code page">
            <section class="service-hero compact">
                <div class="container">
                    <p class="service-kicker">Technical Services</p>
                    <h1>Mods &amp; Custom Code</h1>
                    <p class="service-lead">Custom Scripts, Mod Installation, Server Fixes &amp; Community Tools</p>
                </div>
            </section>
            ...
            <section class="service-section">
                <div class="container">
                    <h2>Simple Project Pricing</h2>
                    <p class="section-intro">Every server is different, so most work is quoted after we review the request. Small changes can be inexpensive. Larger changes may require testing, backups, and live server review.</p>
                    <div class="service-card-grid two-columns">
                        <article class="service-card-item"><h3>Quick Fix or Config Change</h3><p><strong>$20 - $40</strong></p><p>Examples: settings change, small permission fix, simple config edit.</p></article>
                        <article class="service-card-item"><h3>Small Script or Mod Adjustment</h3><p><strong>$30 - $75</strong></p><p>Examples: modify an existing script, add a simple command, adjust a small gameplay feature.</p></article>
                        <article class="service-card-item"><h3>Mod Install or Server Setup</h3><p><strong>$50 - $150</strong></p><p>Examples: install mods, test compatibility, configure server settings.</p></article>
                        <article class="service-card-item"><h3>Custom Feature or Integration</h3><p><strong>$100 - $300+</strong></p><p>Examples: Discord integration, custom server tools, website connection, roleplay system, economy changes.</p></article>
                        <article class="service-card-item"><h3>Hourly Work When Needed</h3><p><strong>$25 - $50/hour</strong></p><p>Used when the work cannot be estimated until the server is reviewed.</p></article>
                    </div>
                </div>
            </section>
            ...
            <section class="service-section">
                <div class="container cta-block">
                    <h2>Tell us what you want your server to do.</h2>
