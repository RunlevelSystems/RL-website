...
<html lang="en">
    <head>
        ...
        <title>World Domination Software | BBS Revival</title>
    ...
    <body>
        ...
        $page_breadcrumb = 'Projects / BBS Revival';
        $current_project_slug = 'bbs-revival';
        ?>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="title-box">
                        ...
                        <h2 class="title mt0">BBS Revival</h2>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul style="color: #8B7355; line-height: 2;">
                                        ...
                                        <li><strong style="color: #8B4513;">File Trading:</strong> Share programs, art, and digital artifacts</li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul style="color: #8B7355; line-height: 2;">
                                        ...
                                        <li><strong style="color: #8B4513;">Virtual Modem:</strong> Simulated dial-up connection experience</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
