...
<html lang="en">
    <head>
        ...
        <title>World Domination Software | Roadkill v2</title>
    ...
    <body>
        ...
        $page_breadcrumb = 'Projects / Roadkill v2';
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="title-box">
                        ...
                        <h2 class="title mt0">Roadkill v2</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div style="background: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 40px; margin-bottom: 40px;">
                            ...
                            <div style="margin-bottom: 20px;">
                                ...
                                <div style="background: #333; height: 8px; border-radius: 4px;">
                                    <div style="background: #8B4513; height: 100%; width: 40%; border-radius: 4px;"></div>
                                </div>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
