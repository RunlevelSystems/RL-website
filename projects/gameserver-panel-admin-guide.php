            ...
            <div class="footer-info">
                ...
                <div class="quick-links" style="margin-top: 20px; padding-top: 15px; border-top: 1px solid #444;">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 8px;">
                        <a href="gameserver-panel.php" class="btn-wds" style="font-size: 11px; padding: 6px 12px; text-decoration: none;">
                            <i class="fas fa-home" style="margin-right: 5px;"></i>
                            Project Overview
                        </a>
                        <a href="gameserver-panel-industry-stats.php" class="btn-wds" style="font-size: 11px; padding: 6px 12px; text-decoration: none;">
