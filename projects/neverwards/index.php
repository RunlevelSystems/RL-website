                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <ul style="color: #8B7355; line-height: 2;">
                                        ...
                                        <li><strong style="color: #8B4513;">Rich Storytelling:</strong> Branching narratives with meaningful choices</li>
                                    </ul>
                                </div>
                                <div class="col-sm-6">
                                    <ul style="color: #8B7355; line-height: 2;">
                                        ...
                                        <li><strong style="color: #8B4513;">Community Events:</strong> Server-wide challenges and celebrations</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div style="background: #1a1a1a; border: 1px solid #333; border-radius: 8px; padding: 40px; margin-bottom: 40px;">
                            ...
                            <div style="margin-bottom: 20px;">
                                ...
                                <div style="background: #333; height: 8px; border-radius: 4px;">
                                    <div style="background: #8B4513; height: 100%; width: 85%; border-radius: 4px;"></div>
                                </div>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                ...
                                <div style="background: #333; height: 8px; border-radius: 4px;">
                                    <div style="background: #8B4513; height: 100%; width: 70%; border-radius: 4px;"></div>
                                </div>
                            </div>
                            <div style="margin-bottom: 20px;">
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
                                ...
                                <div style="background: #333; height: 8px; border-radius: 4px;">
                                    <div style="background: #8B4513; height: 100%; width: 60%; border-radius: 4px;"></div>
                                </div>
                            </div>
                        </div>
