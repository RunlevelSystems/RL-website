    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div style="background:#E8E4D8;border:1px solid #C4C0B4;border-radius:6px;padding:25px;text-align:center;margin-bottom:20px;min-height:240px;">
                ...
                <a href="https://github.com/GameServerPanel/GSP-Agent-Linux" target="_blank" class="btn btn-wds"><i class="fab fa-github" style="margin-right:8px;"></i>View Repository</a>
            </div>
        </div>
...
<div style="background:#D4CFC0;border:1px solid #333;border-radius:8px;padding:40px;margin-bottom:40px;">
    ...
    <ol style="color:#4a4a4a;font-size:16px;line-height:2;padding-left:30px;">
        ...
        <div style="margin-top:15px;display:flex;flex-wrap:wrap;gap:10px;">
            ...
            <a href="https://github.com/GameServerPanel/GSP-Agent-Linux/tree/Panel-stable/documentation" target="_blank" class="btn btn-wds"><i class="fab fa-linux" style="margin-right:8px;"></i>Linux Agent Docs</a>
